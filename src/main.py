...
def main(args) -> None:
    ...
    if args.model == 'bvae':
        ...
        """
        data, in_dim, out_dim = load_autoencoder_data(path=get_relative_path('diverse.txt', 'Data/splits/imdb/training'), retrain_path=args.retrain, device=device, num_ops=args.operators, num_platfs=args.platforms)
